...
import com.raistudies.jqplot4j.builder.series.PieSeriesBuilder;
 ...
 * @author Rahul
 */
public class PieChartBuilder extends AbstractChartBuilder implements ChartBuilder {

    private PieSeriesBuilder seriesBuilder;

    public PieChartBuilder() {
        super();
        seriesBuilder = new PieSeriesBuilder();
    }
    
    
    public PieSeriesBuilder getSeriesBuilder() {
